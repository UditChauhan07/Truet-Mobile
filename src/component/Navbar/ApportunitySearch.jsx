...
const dataList = [
    "Bitumen Polymer Membranes", "Liquid waterproofing and accessories", "Acoustic insulation", "Synthetic membranes", "Thermal insulation",
     
  ];

const ApportunitySearch = () => {
    ...
    return (
        <div ref={containerRef} className="autocomplete-container" style={{ width: "", margin: "5px 1px 15px 1px", position: "relative" }}>
          ...
          <input
            type="text"
            placeholder="Product list Search"
            value={searchTerm}
...
export default ApportunitySearch
